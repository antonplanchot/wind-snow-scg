...
def plotannuel1C(choice,mois,string,U2,SF2,rhos,AC,EReff):
    ...
    plt.subplot(n,1,3)
    plt.plot(mois,rhos[:365*24],color='k',label='masse volumique neige CI')#marker=',',linestyle='None',
    plt.ylabel('ρ [kg/m3]')
    plt.xlim(0.4,13.6)
    plt.legend()
    plt.gca().xaxis.set_ticks(range(1,14,1))
    ...
    plt.savefig(r"C:\Users\Toshiba\Documents\stage L3\Documents\figures\1C_2010"+string+".png")
    plt.show()
    if choice!=0:
        plt.pause(1)
        plt.close()

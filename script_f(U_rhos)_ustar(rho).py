...
fig.colorbar(cax,label='u*-u*t [sans unité]')
...
plt.xlabel('ρs [kg/m3]')
plt.ylabel('U [m/s]')
plt.text(44,55,'érosion',color="red",fontsize='13')
plt.text(40,15,"pas d'érosion",color="red",size='13')
plt.legend()
plt.grid()
plt.xlim(0,100)
plt.ylim(0,100)
plt.savefig(r"C:\Users\Toshiba\Documents\stage L3\Documents\figures\f(u_rhos)2D.png")
plt.show()
...
plt.ylabel('u*t [m/s]')
plt.grid()
plt.savefig(r"C:\Users\Toshiba\Documents\stage L3\Documents\figures\ustarT(rhos)_pour_differents_rhos0.png")
plt.show()
